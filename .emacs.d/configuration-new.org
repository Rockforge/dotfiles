...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    ;; Windows
    (evil-define-key 'normal 'global (kbd ",x") 'split-window-below)
    (evil-define-key 'normal 'global (kbd ",v") 'split-window-right)
    (evil-define-key 'normal 'global (kbd ",o") 'delete-other-windows)
